...
const MAX_LOOTBOXES = 1;    // Maximum number of lootboxes allowed in the scene at any time
const MIN_LOOTBOXES = 1;    // Minimum number of lootboxes to maintain in the scene
